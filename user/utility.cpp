...
std::string GetRoleName(RoleBehaviour* roleBehaviour, bool abbreviated /* = false */)
{
	...
	{
		case RoleTypes__Enum::Engineer:
			return (abbreviated ? "Engie" : "Engineer TF2");
		case RoleTypes__Enum::GuardianAngel:
